...
lib.ssMetadata = [
		{name:"ba_u2_s3_p2_tidy_equipment_atlas_", frames: [[0,1386,580,580],[802,0,592,580],[1165,1752,578,575],[0,0,800,801],[1396,0,581,585],[582,1752,581,579],[582,1165,580,581],[1385,587,581,581],[1164,1170,581,580],[802,582,581,581],[0,803,580,581],[0,1968,352,452],[582,803,196,208],[1892,1685,144,157],[582,1013,148,148],[1747,1346,167,168],[354,1968,135,137],[1745,1853,139,142],[1747,1516,165,167],[1892,1844,139,143],[1747,1685,143,166],[1747,1170,173,174]]}
];
...
(lib.ba_u2_s3_p2_tidy_clean = function() {
	this.initialize(ss["ba_u2_s3_p2_tidy_equipment_atlas_"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();



(lib.ba_u2_s3_p2_tidy_clear = function() {
	this.initialize(ss["ba_u2_s3_p2_tidy_equipment_atlas_"]);
	this.gotoAndStop(1);
}).prototype = p = new cjs.Sprite();
...
(lib.ba_u2_s3_p2_tidy_last = function() {
	this.initialize(ss["ba_u2_s3_p2_tidy_equipment_atlas_"]);
	this.gotoAndStop(2);
}).prototype = p = new cjs.Sprite();
...
(lib.ba_u2_s3_p2_tidy_main_bg_v2 = function() {
	this.initialize(ss["ba_u2_s3_p2_tidy_equipment_atlas_"]);
	this.gotoAndStop(3);
}).prototype = p = new cjs.Sprite();
...
(lib.ba_u2_s3_p2_tidy_methodical = function() {
	this.initialize(ss["ba_u2_s3_p2_tidy_equipment_atlas_"]);
	this.gotoAndStop(4);
}).prototype = p = new cjs.Sprite();
...
(lib.ba_u2_s3_p2_tidy_neat = function() {
	this.initialize(ss["ba_u2_s3_p2_tidy_equipment_atlas_"]);
	this.gotoAndStop(5);
}).prototype = p = new cjs.Sprite();
...
(lib.ba_u2_s3_p2_tidy_partial = function() {
	this.initialize(ss["ba_u2_s3_p2_tidy_equipment_atlas_"]);
	this.gotoAndStop(6);
}).prototype = p = new cjs.Sprite();
...
(lib.ba_u2_s3_p2_tidy_photocopy = function() {
	this.initialize(ss["ba_u2_s3_p2_tidy_equipment_atlas_"]);
	this.gotoAndStop(7);
}).prototype = p = new cjs.Sprite();
...
(lib.ba_u2_s3_p2_tidy_refill = function() {
	this.initialize(ss["ba_u2_s3_p2_tidy_equipment_atlas_"]);
	this.gotoAndStop(8);
}).prototype = p = new cjs.Sprite();
...
(lib.ba_u2_s3_p2_tidy_store = function() {
	this.initialize(ss["ba_u2_s3_p2_tidy_equipment_atlas_"]);
	this.gotoAndStop(9);
}).prototype = p = new cjs.Sprite();
...
(lib.ba_u2_s3_p2_tidy_unused = function() {
	this.initialize(ss["ba_u2_s3_p2_tidy_equipment_atlas_"]);
	this.gotoAndStop(10);
}).prototype = p = new cjs.Sprite();
...
(lib.ba_u2_s6_p2_clipboard = function() {
	this.initialize(ss["ba_u2_s3_p2_tidy_equipment_atlas_"]);
	this.gotoAndStop(11);
}).prototype = p = new cjs.Sprite();
...
(lib.Scene_1_images = function(mode,startPosition,loop) {
	...
	// images
	this.instance = new lib.George();
	this.instance.parent = this;
	this.instance.setTransform(297,25);

	this.instance_1 = new lib.ba_u2_s3_p2_tidy_neat();
	this.instance_1.parent = this;
	this.instance_1.setTransform(142,201,0.9975,0.9975);

	this.instance_2 = new lib.Jane();
	this.instance_2.parent = this;
	this.instance_2.setTransform(563,118);

	this.instance_3 = new lib.ba_u2_s3_p2_tidy_methodical();
	this.instance_3.parent = this;
	this.instance_3.setTransform(44,161);

	this.instance_4 = new lib.Rhonda();
	this.instance_4.parent = this;
	this.instance_4.setTransform(576,277);

	this.instance_5 = new lib.ba_u2_s3_p2_tidy_partial();
	this.instance_5.parent = this;
	this.instance_5.setTransform(34,48);

	this.instance_6 = new lib.Paul();
	this.instance_6.parent = this;
	this.instance_6.setTransform(616,448);

	this.instance_7 = new lib.ba_u2_s3_p2_tidy_store();
	this.instance_7.parent = this;
	this.instance_7.setTransform(17,145);

	this.instance_8 = new lib.Naomi();
	this.instance_8.parent = this;
	this.instance_8.setTransform(500,587);

	this.instance_9 = new lib.ba_u2_s3_p2_tidy_photocopy();
	this.instance_9.parent = this;
	this.instance_9.setTransform(24,57);

	this.instance_10 = new lib.Neel();
	this.instance_10.parent = this;
	this.instance_10.setTransform(339,630);

	this.instance_11 = new lib.ba_u2_s3_p2_tidy_clear();
	this.instance_11.parent = this;
	this.instance_11.setTransform(8,47);

	this.instance_12 = new lib.Polly();
	this.instance_12.parent = this;
	this.instance_12.setTransform(181,574);

	this.instance_13 = new lib.ba_u2_s3_p2_tidy_unused();
	this.instance_13.parent = this;
	this.instance_13.setTransform(179,39);

	this.instance_14 = new lib.Monique();
	this.instance_14.parent = this;
	this.instance_14.setTransform(16,457);

	this.instance_15 = new lib.ba_u2_s3_p2_tidy_last();
	this.instance_15.parent = this;
	this.instance_15.setTransform(146,27);

	this.instance_16 = new lib.Harold();
	this.instance_16.parent = this;
	this.instance_16.setTransform(83,286);

	this.instance_17 = new lib.ba_u2_s3_p2_tidy_refill();
	this.instance_17.parent = this;
	this.instance_17.setTransform(177,102);

	this.instance_18 = new lib.Tom();
	this.instance_18.parent = this;
	this.instance_18.setTransform(111,100);

	this.instance_19 = new lib.ba_u2_s3_p2_tidy_clean();
	this.instance_19.parent = this;
	this.instance_19.setTransform(197,204);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_1},{t:this.instance}]},1).to({state:[{t:this.instance_3},{t:this.instance_2}]},1).to({state:[{t:this.instance_5},{t:this.instance_4}]},1).to({state:[{t:this.instance_7},{t:this.instance_6}]},1).to({state:[{t:this.instance_9},{t:this.instance_8}]},1).to({state:[{t:this.instance_11},{t:this.instance_10}]},1).to({state:[{t:this.instance_13},{t:this.instance_12}]},1).to({state:[{t:this.instance_15},{t:this.instance_14}]},1).to({state:[{t:this.instance_17},{t:this.instance_16}]},1).to({state:[{t:this.instance_19},{t:this.instance_18}]},1).wait(1));
...
(lib.Scene_1_clipboard_image = function(mode,startPosition,loop) {
	...
	// clipboard_image
	this.instance = new lib.ba_u2_s6_p2_clipboard();
	this.instance.parent = this;
	this.instance.setTransform(11.45,151.65,0.8019,0.8019,-1.8854);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1).to({_off:false},0).wait(1).to({rotation:-11.1173,x:478.1,y:399.05},0).wait(1).to({rotation:-6.591,x:488.65,y:449.85},0).wait(1).to({rotation:-4.8367,x:473.3,y:62.95},0).wait(1).to({rotation:-7.3775,x:474,y:201.15},0).wait(1).to({rotation:-8.8732,x:476.15,y:201.6},0).wait(1).to({rotation:-4.6256,x:1.8,y:104.85},0).wait(1).to({rotation:-5.6305,x:408.25,y:453.65},0).wait(1).to({rotation:-5.8639,x:42.7,y:455.35},0).wait(1).to({rotation:-5.6305,x:3,y:432.05},0).wait(1));
...
(lib.Scene_1_background = function(mode,startPosition,loop) {
	...
	// background
	this.instance = new lib.ba_u2_s3_p2_tidy_main_bg_v2();
	this.instance.parent = this;
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.background.setTransform(399,399.5,1,1,0,0,0,399,399.5);
	...
	this.timeline.addTween(cjs.Tween.get(this.background).wait(11));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(398,398,427,417.9);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"ba_u2_s3_p2_tidy_equipment_atlas_.png", id:"ba_u2_s3_p2_tidy_equipment_atlas_"}
	],
	preloads: []
};
