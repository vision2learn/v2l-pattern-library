...
sections:
    ...
    -
        ...
        include: 
            type: on-the-web
            links:
                improve your performance: https://www.iris.xyz/development/20-ways-improve-your-performance-work 
                ways to improve: https://www.theexceptionalskills.com/ways-to-improve-work-performance/
    ...
    -
        ...
        copy: |
            ...
            Select the images below to see the ways business performance ties in with employee performance.
        subInc: 
            type: slider
            title:
            slides:
    ...
    -
    -
        title: Case Study - How business productivity can affect employees
        layout: media
        ...
        img: /images/svg/ba/ba_u1_s6_p1_image_1.svg
    -
    -
        title: Quiz - Improve or stay the same?
        theme: i-quiz 
        subInc: 
            type: quick-quiz
            content:
                ...
                Master new technologies:
                    answers:
                        Improve: true
                        Stay the same: false
                Excel at performing tasks and improve efficiency: 
                    answers:
                        Improve: true
                        Stay the same: false
                Keep performance the same: 
                    answers:
                        Improve: false
                        Stay the same: true
                Don't reduce price:
                ...
                Profit grows:
                    answers:
                        Improve: true
                        Stay the same: false
                Staff must be laid off:
                    answers:
                        Improve: false
                        Stay the same: true
                New staff can be employed:
                    answers:
                        Improve: true
                        Stay the same: false
    -
    ...
    -
        ...
        theme: t-bg-primary
        copy: |
            Improvement can take place in the following ways by learning from:
            - Mistakes
            - Performance reviews
    ...
    -
        ...
        copy: |
            ...
            See below for some examples of mistakes and the best way to respond to them.
        subInc:
            type: accordion
            content:
            -
                ...
                img: /images/svg/ba/ba_u1_s6_p1_accordion_1.svg
            -
                ...
                copy: |
                    ...
                    * Blaming others, and
                    * Looking for excuses.
                img: /images/svg/ba/ba_u1_s6_p1_accordion_2.svg
            -
                ...
                img: /images/svg/ba/ba_u1_s6_p1_accordion_3.svg
    -
    -
        title: Summary
